...
func main() {
	...
	*/
	...
	//需求1：需要一个具体的苹果对象
	//1-先要一个具体的苹果工厂
	var appleFac = new(AppleFactory)
	//2-生产相对应的具体水果
	var apple = appleFac.CreateFruit()

	apple.Show()

	//需求2：需要一个具体的香蕉对象
	//1-先要一个具体的香蕉工厂
	var bananaFac = new(BananaFactory)
	//2-生产相对应的具体水果
	var banana = bananaFac.CreateFruit()

	banana.Show()

	//需求3：需要一个具体的梨对象
	//1-先要一个具体的梨工厂
	var pearFac = new(PearFactory)
	//2-生产相对应的具体水果
	...
	//需求4：需要一个日本的苹果？
	//1-先要一个具体的日本评估工厂
	var japanAppleFac = new(JapanAppleFactory)
	//2-生产相对应的具体水果
	var japanApple = japanAppleFac.CreateFruit()
